...
public class EventEntity {
    ...
    @Column(name = "attendee_projected_count", nullable = false)
    private int attendeeProjectedCount;
    ...
    public int getAttendeeProjectedCount() { return attendeeProjectedCount; }
